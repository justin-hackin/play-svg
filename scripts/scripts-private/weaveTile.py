...
def buildWeaveTile( boxSize, stripWidthRatio):
    ...
    lineAttrs = {'style':'stroke: black;stroke-width:4;stroke-linecap:none'}
...
docu.append( buildWeaveTile(tileSize, 0.5 ))
docu.append( buildWeaveTile(tileSize, 0.3 ))
docu.append( buildWeaveTile(tileSize, 0.1 ))
docu.writeSVG("weaveTile.svg" )
print "done"
